 ...
 * @param {boolean} [params.dryRun=true]
 */
// Shopify REST API allows 2 calls/second; 600 ms between products keeps us safely under.
const SHOPIFY_RATE_LIMIT_DELAY_MS = 600;
...
export async function cleanupAllProductVariantDiscriminators({ domain, token, dryRun = true }) {
  ...
  for (const product of products) {
    ...
    await new Promise(resolve => setTimeout(resolve, SHOPIFY_RATE_LIMIT_DELAY_MS));
  }
