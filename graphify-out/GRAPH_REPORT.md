...
## Corpus Check
- 112 files · ~46,874 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 779 nodes · 1850 edges · 64 communities (35 shown, 29 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 77 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b17a224d`
...
5. `productOptionTypes()` - 23 edges
6. `filterCustomerOptionTypes()` - 22 edges
7. `Impeccable Skill` - 21 edges
8. `Button()` - 20 edges
...
Cohesion: 0.12
Nodes (46): GET(), loadProductContext(), POST(), PUT(), advanceChain(), applyChainDefaults(), buildChainKey(), createOrUpdateVariantForCode() (+38 more)
...
Cohesion: 0.12
Nodes (18): TYPE_OPTIONS, DEFAULT_KARAT_PRESET, isPrimaryCatalogOption(), typesEqual(), Dialog(), DialogContent(), DialogDescription(), DialogFooter() (+10 more)

### Community 3 - "API Routes Axios"
Cohesion: 0.10
Nodes (28): api, BASE_URL, GET(), jsonNoStore(), NO_STORE_HEADERS, GET(), jsonNoStore(), NO_STORE_HEADERS (+20 more)

### Community 4 - "Variant Model"
Cohesion: 0.07
Nodes (29): customerOptionComboKey(), filterSelectableOptionValues(), hasDuplicateCustomerOptionCombo(), hasDuplicatePrimaryOptionCombo(), catalog, filtered, gmUi, legacySuffixedVariant (+21 more)
...
Cohesion: 0.17
Nodes (22): fetchVariantOptionSuggestions(), allowsSharedOptionValueAcrossVariants(), allVariantsForOptionScan(), displayVariantTitle(), getOptionSelectUiState(), getUsedOptionValues(), isDefaultTitleOnlyOptions(), isGwebWeightOptionName() (+14 more)

### Community 7 - "FN6 Spec Builder"
Cohesion: 0.08
Nodes (43): bodyHtmlToSpec(), buildDefaultDescription(), buildDefaultSpec(), formatCurrency(), isSpecLine(), mergeToBodyHtml(), SPEC_LINE_PREFIXES, specToBodyHtml() (+35 more)

### Community 8 - "Generated File Detection"
Cohesion: 0.27
Nodes (11): buildRepairSelections(), fetchFn6ByMco(), karatLabelFromFn6(), matchOptionValueFromSuffix(), OPTION_FIELDS, skuSuffixAfterMco(), variantNeedsRepair(), deriveSubSku() (+3 more)
...
Cohesion: 0.13
Nodes (19): inter, metadata, RootLayout(), Providers(), AuthGate(), LoadingScreen(), PUBLIC, DashboardShell() (+11 more)

### Community 11 - "Shared UI Utils"
Cohesion: 0.15
Nodes (19): cn(), Fn6CodeCombobox(), Avatar, AvatarFallback, AvatarImage, Calendar(), CalendarDayButton(), Checkbox (+11 more)
...
Cohesion: 0.15
Nodes (15): fn6Api, Fn6CreateModal(), Fn6DetailModal(), formatCurrency(), useImageUpload(), parseApiError(), Badge, ImageUploader() (+7 more)

### Community 15 - "Variant API Routes"
Cohesion: 0.10
Nodes (39): GET(), DELETE(), PUT(), DELETE(), POST(), GET(), repairAllProductVariantOptions(), resolveMcoFromVariants() (+31 more)

### Community 16 - "Shopify Variant Types"
Cohesion: 0.22
Nodes (22): shopifyGraphql(), convertDefaultTitleOption(), ensureTargetOptionValuesPresent(), ensureVariantsHaveOptionPositions(), isDefaultTitleOnly(), OPTION_FIELDS, productGid(), realignVariantsToProductOptions() (+14 more)

### Community 17 - "Community 17"
Cohesion: 0.40
Nodes (6): normalizeTargetTypes(), defaultVariantTypesForNewProduct(), filterOptionsForUi(), mergeOptionTypesCatalog(), orderVariantTypes(), normalizeTypes()

### Community 19 - "UI Components"
Cohesion: 0.07
Nodes (38): NAV, COLUMNS, formatCurrency(), formatNumber(), ScanPage(), ScanResult(), SKELETON_ROWS, BulkRepairVariantOptionsButton() (+30 more)

### Community 20 - "UI Form Controls"
Cohesion: 0.22
Nodes (14): formatCurrency(), ItemsManagementTab(), roundToNearest5(), ShopifyPublishForm(), VariantsPanel(), Button(), buttonVariants, Card (+6 more)
...
Cohesion: 0.18
Nodes (20): GET(), extractProductImages(), findShopifyProduct(), gidToNumericId(), packFromProduct(), packFromVariant(), parseProductCollections(), slugifyHandle() (+12 more)

### Community 25 - "Variant Cleanup"
Cohesion: 0.30
Nodes (10): POST(), cleanupAllProductVariantDiscriminators(), cleanupProductVariantDiscriminators(), hasDiscriminatorOption(), hasSuffixedValues(), OPTION_FIELDS, planSuffixStrip(), restUpdateVariantField() (+2 more)

### Community 37 - "FN6 Constants"
Cohesion: 0.15
Nodes (19): Fn6ItemMetadataPanel(), BOOL_OPTIONS, TYPE_COLORS, TYPE_LABELS, TYPE_OPTIONS_MODAL, fn6HasAssignableStock(), fn6Quantity(), fn6StockStatus() (+11 more)
...
- **Why does `cn()` connect `Shared UI Utils` to `FN6 Item Fields`, `FN6 Spec Builder`, `App Layout Shell`, `Design Parser`, `Community 13`, `FN6 Product Modals`, `UI Components`, `UI Form Controls`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `filterCustomerOptionTypes()` connect `UI Primitives` to `FN6 Item Fields`, `Variant Model`, `FN6 Constants`, `CSP Detection`, `Generated File Detection`, `Community 17`, `UI Components`, `Variant Cleanup`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `getShopifyToken()` connect `Variant API Routes` to `Shopify API Routes`, `Variant Cleanup`, `API Routes Axios`, `UI Primitives`?**
